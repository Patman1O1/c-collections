...
class CVector(ConanFile):
    ...
    def package_info(self) -> None:
        self.cpp_info.set_property("cmake_target_name", "collections::c_vector")
        self.cpp_info.libs = ["c_vector"]
        if not bool(self.options.build_shared_libs):
            self.cpp_info.defines = ["C_VECTOR_STATIC_DEFINE"]
