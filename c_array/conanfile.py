...
class CArray(ConanFile):
    name = "c_array"
    version = "0.1.0"
    author = "Patman1O1"
    description = \
    """
    A library with helpers functions and macros for C arrays.
    """
    ...
    def package_info(self) -> None:
        self.cpp_info.set_property("cmake_target_name", "collections::c_array")
        self.cpp_info.libs = ["c_array"]
        if not bool(self.options.build_shared_libs):
            self.cpp_info.defines = ["C_ARRAY_STATIC_DEFINE"]
