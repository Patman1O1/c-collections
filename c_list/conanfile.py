...
class CList(ConanFile):
    ...
    def package_info(self) -> None:
        self.cpp_info.set_property("cmake_target_name", "collections::c_list")
        self.cpp_info.libs = ["c_list"]
        if not bool(self.options.build_shared_libs):
            self.cpp_info.defines = ["C_LIST_STATIC_DEFINE"]
