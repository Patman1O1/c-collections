...
class CBtree(ConanFile):
    ...
    def package_info(self) -> None:
        self.cpp_info.set_property("cmake_target_name", "collections::c_btree")
        self.cpp_info.libs = ["c_btree"]
        if not bool(self.options.build_shared_libs):
            self.cpp_info.defines = ["C_BTREE_STATIC_DEFINE"]
