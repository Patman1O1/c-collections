...
class CHtable(ConanFile):
    ...
    def package_info(self) -> None:
        self.cpp_info.set_property("cmake_target_name", "collections::c_htable")
        self.cpp_info.libs = ["c_htable"]
        if not bool(self.options.build_shared_libs):
            self.cpp_info.defines = ["C_HTABLE_STATIC_DEFINE"]
